with plan_row as (
  ...
  values
    ...
    ('dq', 'DQ', 'DQ', 'DQ', 3, 'South Houston route: A''lena and Christopher L at 11:30 AM.'),
    ('annie', 'Annie', 'Annie', 'AK', 4, 'Nicholas, Vera, Zay, and Amanda route. Amanda is with Annie, so they will go together.'),
    ('dawson', 'Dawson', 'Dawson', 'DW', 5, 'Dawson is only picking up Sherese. Arrive to Sherese by 11:45 AM.'),
    ('precious', 'Precious', 'Precious', 'PR', 6, 'Pick up DaSilva at 10:50 AM, then Emmanuel Mitch and Christopher R follow.'),
  ...
  values
    ...
    ('dq', 1, 'A''lena', '(713) 902-2393', '9425 Ashville Dr, Houston, TX', 'South Houston', '11:30 AM', '11:25 AM', 'DQ route', 'DQ pickup at the same address as Christopher L.'),
    ('dq', 2, 'Christopher L', '(832) 942-1381', '9425 Ashville Dr, Houston, TX', 'South Houston', '11:30 AM', '11:25 AM', 'DQ route', 'Same pickup stop as A''lena.'),
    ...
    ('annie', 4, 'Amanda', '', '9700 Leawood Blvd Apt 1004, Houston, TX', 'Southwest Houston', '12:00 PM', '11:55 AM', 'Annie route', 'Amanda is with Annie; they will go together.'),
    ('dawson', 1, 'Sherese', '', '3416 Benfield Dr, Houston, TX', 'West Houston', '11:45 AM', '11:40 AM', 'Dawson route', 'Dawson is only picking up Sherese.'),
    ('precious', 1, 'DaSilva', '(928) 310-2377', '9796 Windwater Dr, Houston, TX', 'Southeast Houston', '10:50 AM', '10:45 AM', 'Precious route', 'Precious should pick up DaSilva at 10:50 AM.'),
    ('precious', 2, 'Emmanuel Mitch', '(281) 841-8159', '1805 Valentine St, Houston, TX', 'Midtown', '11:15 AM', '11:10 AM', 'Precious route', 'Follows DaSilva on Precious route.'),
    ('precious', 3, 'Christopher R', '(832) 299-0964', '2418 Francis St, Houston, TX', 'Third Ward', '11:25 AM', '11:20 AM', 'Precious route', ''),
